...
| 0.0.8 | 打包余项：英文 README + 中文版、`ti --version`、`package.json` 元信息、打包检查脚本 | 已提交，未发 npm |
| 1.0.0 | 初版：上表待发齐了 | 未到 |
